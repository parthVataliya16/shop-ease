...
const productListing = (products) => {
    ...
    products.forEach((product) => {
        ...
        for (const index in product) {
            ...
            document.getElementsByClassName("productData")[rowNumber - 1].appendChild(data);
        ...
        document.getElementsByClassName("productData")[rowNumber - 1].appendChild(actionOnproductData);
        actionOnproductData.classList.add("actionOnproductData", "dropdown");

        const numberOfActionOnproductDataClass = document.getElementsByClassName("actionOnproductData").length;
        const actionButton = document.createElement("button");
        document.getElementsByClassName("actionOnproductData")[numberOfActionOnproductDataClass - 1].appendChild(actionButton);
        actionButton.classList.add("actionButton");
        actionButton.innerHTML = "Action"

        const dropdownButtons = document.createElement("div");
        document.getElementsByClassName("actionOnproductData")[numberOfActionOnproductDataClass - 1].appendChild(dropdownButtons);
        ...
        document.getElementsByClassName("updateButton")[numberOfUpdateButtonClass - 1].appendChild(updateproduct);
    ...
    $.ajax({
        ...
        success: function(result) {
            ...
            if (result.status == 200) {
                ...
                document.getElementsByClassName("products")[0].innerHTML = result.message;
            }
        }
    })
}
