...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="./../../public/assets/css/updateProduct.css">
            ...
            <div class="inner">
                <form id="productUpdateForm">
                    ...
                    <div class="submitButton">
                        <button class="btn submit" id="productUpdateForm">Submit</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script src="./../../public/assets/js/updateProduct.js"></script>
</html>